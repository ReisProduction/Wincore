...
/// <summary>
/// Text utilities for string manipulation and localization.
/// </summary>
public static class TextUtils
{
    ...
    /// </summary>
    public static char ApplyShiftToNonLetter(char c) => c switch
    {
        '1' => '!',
        '2' => '@',
        '3' => '#',
    ...
    /// </summary>
    public static char ApplyAltGrToNonLetter(char c) => c switch
    {
        'q' or 'Q' => '@',
        'e' or 'E' => '€',
        '2' => '²',
